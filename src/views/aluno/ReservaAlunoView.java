 ...
 * @author rhau
 */
public class ReservaAlunoView extends javax.swing.JDialog {

    ReservaAlunoDAO rdao = new ReservaAlunoDAO();
    ...
    public boolean validaCampos() {
        ...
        // AUTOMATICO
        /*if (txtVazio(txtRetirada, "a retirada"))
            return false;
        else {
            SimpleDateFormat sdf = new SimpleDateFormat("dd/MM/yyyy");
            sdf.setLenient(false);
            try {
                sdf.parse(txtRetirada.getText());
            } catch (Exception e) {
        ...
        if (txtVazio(txtEntrega, "a entrega"))
            return false;
        else {
            SimpleDateFormat sdf = new SimpleDateFormat("dd/MM/yyyy");
            sdf.setLenient(false);
            try {
                sdf.parse(txtEntrega.getText());
            } catch (Exception e) {
    ...
    //Construtor
    public ReservaAlunoView(java.awt.Frame parent, boolean modal) throws SQLException {
        super(parent, modal);
        initComponents();
        trataEdicao(false);
        atualizaTabela();
    ...
    private void initComponents() {
        ...
        lblReservasTitulo.setText("Gerenciamento de Reservas - Alunos");
        ...
        lbRetirada.setText("Data de retirada a partir de");
        ...
        binding = org.jdesktop.beansbinding.Bindings.createAutoBinding(org.jdesktop.beansbinding.AutoBinding.UpdateStrategy.READ_WRITE, tblReservas, org.jdesktop.beansbinding.ELProperty.create("${selectedElement.user.nome}"), txtInfoAluno, org.jdesktop.beansbinding.BeanProperty.create("text"));
        bindingGroup.addBinding(binding);
            ...
            .addGroup(abaManutencaoLayout.createSequentialGroup()
                ...
                .addGroup(abaManutencaoLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    .addGroup(abaManutencaoLayout.createSequentialGroup()
                        ...
                        .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
                        .addComponent(txtInfoRetirada, javax.swing.GroupLayout.PREFERRED_SIZE, 98, javax.swing.GroupLayout.PREFERRED_SIZE)
                    ...
                    .addGroup(abaManutencaoLayout.createSequentialGroup()
                        ...
                        .addGroup(abaManutencaoLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                            ...
                            .addComponent(txtInfoAluno, javax.swing.GroupLayout.PREFERRED_SIZE, 354, javax.swing.GroupLayout.PREFERRED_SIZE))
        ...
        abaManutencaoLayout.setVerticalGroup(
            ...
            .addGroup(javax.swing.GroupLayout.Alignment.TRAILING, abaManutencaoLayout.createSequentialGroup()
                ...
                .addGroup(abaManutencaoLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    ...
                    .addGroup(javax.swing.GroupLayout.Alignment.TRAILING, abaManutencaoLayout.createSequentialGroup()
                        .addGroup(abaManutencaoLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.BASELINE)
                            .addComponent(lbRetirada, javax.swing.GroupLayout.PREFERRED_SIZE, 17, javax.swing.GroupLayout.PREFERRED_SIZE)
        ...
        layout.setHorizontalGroup(
            ...
            .addGroup(javax.swing.GroupLayout.Alignment.TRAILING, layout.createSequentialGroup()
                .addContainerGap(javax.swing.GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE)
                .addComponent(lblReservasTitulo)
                .addGap(150, 150, 150))
        );
        ...
        if (linhaSelecionada >= 0) {
            if (JOptionPane.showOptionDialog(null, "Você deseja mesmo cancelar e reserva?",
                ...
                try {
                    ...
                    Logger.getLogger(ReservaAlunoView.class.getName()).log(Level.SEVERE, null, ex);
                }
            }
        } else {
        ...
        if (busca.length() > 0) {
            ...
            if (ehNumero) {
                ...
                l1.stream().forEach((alunos) -> {
                    listReservas.addAll(rdao.buscarQualquer(rdao.getSqlBuscaAluno(), alunos.getCodigo()));
                });
                int linhas = listReservas.size() - 1;
                if (linhas >= 0) {
                    tblReservas.setRowSelectionInterval(0, 0);
    ...
    private void btnSalvarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnSalvarActionPerformed
        if (validaCampos()) {
            int linhaSelecionada = tblReservas.getSelectedRow();
            Reserva r = listReservas.get(linhaSelecionada);
            r.setUser((Aluno) cbxUser.getSelectedItem());
            r = corrigeDatas(r);
    ...
    private void btnEfetuarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnEfetuarActionPerformed
        if (cbxLivro.getItemCount() == 0) {
            JOptionPane.showConfirmDialog(null, "Não há livros disponíveis para a reserva.",
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(ReservaAlunoView.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                ReservaAlunoView dialog = null;
                try {
                    dialog = new ReservaAlunoView(new javax.swing.JFrame(), true);
                } catch (SQLException ex) {
                    Logger.getLogger(ReservaAlunoView.class.getName()).log(Level.SEVERE, null, ex);
                }
