 ...
 * @author rhau
 */
public class MultaAlunoView extends javax.swing.JDialog {

    AlunoDAO adao = new AlunoDAO();

    public void atualizaTabela() throws SQLException {
        List<Aluno> alunos = adao.buscarTodos();
        listMultas.clear();

        alunos.stream().filter((a) -> (a.getValorMulta() > 0)).map((a) -> {
            Multa m = new Multa(a, a.getValorMulta());
            return m;
        }).forEach((m) -> {
            listMultas.add(m);
        });
    ...
    //Construtor
    public MultaAlunoView(java.awt.Frame parent, boolean modal) throws SQLException {
        super(parent, modal);
        new MultasControl();
        initComponents();
        atualizaTabela();
    ...
    private void initComponents() {
        ...
        lblMultasTitulo.setText("Gerenciamento de multas - Alunos");
        ...
        if (busca.length() > 0) {
            ...
            if (linhas >= 0) {
                ...
                try {
                    ...
                    Logger.getLogger(MultaAlunoView.class.getName()).log(Level.SEVERE, null, ex);
                }
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(MultaAlunoView.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                MultaAlunoView dialog = null;
                try {
                    dialog = new MultaAlunoView(new javax.swing.JFrame(), true);
                } catch (SQLException ex) {
                    Logger.getLogger(MultaAlunoView.class.getName()).log(Level.SEVERE, null, ex);
                }
